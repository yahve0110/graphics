    ...
    <div className='projectsGraph'>
      ...
      <svg width="600" height="400">
        {recentProjects.map(project => {
          ...
          const y = 400 - height - 30; // Calculate the bar height relative to the bottom of the SVG
          const x = startX;
          startX += barWidth + barMargin; // Increment the initial position for the next bar
